...
public class ExemploStreamAPI {
    public static void main(String[] args){
        ...
        // Retorna o elemento com menor núero de letras
        ...
        System.out.println("Tem algum elemento com a minúscula no nome? "+ estudantes.stream().anyMatch((elemento) -> elemento.contains("r")));

        // Retorna true e emji, eçe,emtp ´pssie a çetra a ,omúscula no nome
        ...
        .collect(Collectors.groupingBy(estudante -> estudante(estudante.indexOf("-") + 1))));
         */
