...
public class ExemploTreeMap {
    ...
    public static void main(String[] args){
        ...
        // Retorna a priemira capital acima na árvore da capital parametrizada
        ...
        Map.Entry<String, String> lastEntry = treeCapitais.lastEntry();
        ...
        while (iterator.hasNext()){
            ...
            System.out.println("While " + key + " - " + treeCapitais.get(key));
        }

        for (String capital: treeCapitais.keySet()){
            System.out.println("For " + capital + " - " + treeCapitais.get(capital));
        }

        for (Map.Entry<String, String> capital: treeCapitais.entrySet()){
            System.out.println("Map " +  capital.getKey() + " - " + capital.getValue());
        }
