...
var animal = {
  nome: 'Elefante',
  tipo: 'terrestre',
  executarSom: function executarSom(_executarSom) {
    return "".concat(_executarSom, "dB");
  }
};
...
var felino = {
  ...
  tipo: "terrestre",
  visaoNoturna: true,
  executarSom: function executarSom(_executarSom2) {
    return "".concat(_executarSom2, "dB");
  }
};
